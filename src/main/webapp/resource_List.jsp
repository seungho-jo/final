			...
			<div class="card" style="display: block;">
				<div class="card-body">
					<table class="table">
						...
						<tbody>
							<tr class="hoverTr">
								...
								<td>부장</td>
								<td>2021년 10월 1일</td>
								<td><span><a data-toggle="modal" data-target="#exampleModalCenter" data-placement="top" title="Close"><i
					...
					<div class="bootstrap-modal">
                                    ...
                                    <table class="table" id="tablemodalId">  <!--table table-bordered verticle-middle table-responsive-sm  -->
                                        <thead>
                                            <tr id="tableBigname" >
                                                <th scope="col">이름</th>
                                                <th scope="col">부서</th>
                                        ...
                                        <tbody>
                                          ...
                                          <div class="div-result" id="result" method="post"> <!-- tr누르면 이 div로 담아옴  -->
...
//var str=""
	...
	$("#tablemodalId tr").click(function(){		
	   ...
	   for(var i = 0; i < tdArr.length; i++) {
		   tdArrText += "<font size='5' font color=gray>"+tdArr[i][0]+"</font>"
		   +"<font size='5' font color=gray>"+tdArr[i][1]+"<br></font>"; // 출력은 바깥에서 선언한 배열을 출력    
	   }
