...
.form-name-badge-span, .form-dept-badge-span, .form-jobGrade-badge-span, .form-temporary-id-pass-badge-span{ /*뱃지*/
   ...
   <div id="main-wrapper">
      ...
      <div id="card1">
         ...
         <div class="form-temporary-id-pass-badge">
            <span class="form-temporary-id-pass-badge-span">임시 아이디 & 비밀번호</span> <!-- 임시 아이디 비밀번호 뱃지  --> 
            </div><!-- .form-temporary-id-pass-badge -->
            <button type="button" class="btn btn-outline-primary" id="but01">생성하기</button>
             ...
             <input id="temporary-pass" class="form-control" type="text" disabled>
